...
## Карьерная лестница
Карьерная лестница  — это возможный путь развития инженера в Heapix в зависимости от того, какие задачи он решает, и какие основные скиллы при этом использует.
...
В настоящий момент у нас в Heapix существуют такие уровни:
- [Intern (стажёр)](https://github.com/AlexBogatko/playbook/blob/main/developer-profile.md#intern)
- [junior](https://github.com/AlexBogatko/playbook/blob/main/developer-profile.md#junior)
- [Middle](https://github.com/AlexBogatko/playbook/blob/main/developer-profile.md#middle)
- [Senior](https://github.com/AlexBogatko/playbook/blob/main/developer-profile.md#senior)
- [Lead](https://github.com/AlexBogatko/playbook/blob/main/developer-profile.md#lead)
- [Principal](https://github.com/AlexBogatko/playbook/blob/main/developer-profile.md#principal)
...
### Инженерная культура
- Изучает с наставником лучшие практики Heapix, учится писать качественный код или тестировать используя существующие тестовые модели.
...
### Инженерная культура
- Проводит Code Review коллег, способствуя тому, чтобы вливаемый код соответствовал лучшим практикам Heapix, был тестопригодным, безопасным и поддерживаемым.
...
- При принятии решений анализирует и минимизирует возможные риски и негативные последствия. Например
  - При проектировании тестовой модели учитывает как работает Heapix в целом.
...
- Анализирует возникающие проблемы, старается докопаться до сути и решить корневую проблему. Предлагает и продвигает превентивные решения для предотвращения рецидивов. Отличается от Lead и Senior масштабом. Principal думает про весь Heapix целиком, а не про какую-то отдельную область.
